...
- name: AWS Shield API - Describe Protection
  ...
  - type: x-postman-collection
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/descriptions/master/_listings/aws-shield/actiondescribeprotection-get-postman.md
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/descriptions/master/_listings/aws-shield/actiondescribeprotection-get-openapi.md
- name: AWS Shield API - Describe Protection
  x-api-slug: actiondescribeprotection-get
  description: Lists the details of a.
  image: http://kinlane-productions.s3.amazonaws.com/api-evangelist-site/company/logos/Screen
