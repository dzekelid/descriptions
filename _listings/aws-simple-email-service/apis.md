...
- name: AWS Simple Email Service API - Describe Active Receipt Rule Set
  x-api-slug: actiondescribeactivereceiptruleset-get
  description: Returns the metadata and receipt rules for the receipt rule set that
    is currently active.
  image: http://kinlane-productions.s3.amazonaws.com/api-evangelist-site/company/logos/Application-Services_AmazonSES.png
  ...
  - type: x-postman-collection
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/descriptions/master/_listings/aws-simple-email-service/actiondescribeactivereceiptruleset-get-postman.md
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/descriptions/master/_listings/aws-simple-email-service/actiondescribeactivereceiptruleset-get-openapi.md
...
- name: AWS Simple Email Service API - Describe Receipt Rule Set
  ...
  properties:
  - type: x-postman-collection
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/descriptions/master/_listings/aws-simple-email-service/actiondescribereceiptruleset-get-postman.md
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/descriptions/master/_listings/aws-simple-email-service/actiondescribereceiptruleset-get-openapi.md
- name: AWS Simple Email Service API - Describe Receipt Rule Set
  x-api-slug: actiondescribereceiptruleset-get
  description: Returns the details of the specified receipt rule set.
  image: http://kinlane-productions.s3.amazonaws.com/api-evangelist-site/company/logos/Application-Services_AmazonSES.png
