...
x-complete: 0
info:
  title: Dezrez Returns a list of the distinct defined custom descriptions for a property
  version: 1.0.0
  description: Returns a list of the distinct defined custom descriptions for a property.
host: api.dezrez.com
basePath: /
schemes:
- http
